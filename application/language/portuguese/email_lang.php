...
$lang['email_send_failure_phpmail'] = 'Não foi possível enviar e-mail usando PHP mail(). Seu servidor pode não estar configurado para enviar e-mails por este método.';
$lang['email_send_failure_sendmail'] = 'Não foi possível enviar e-mail usando PHP Sendmail. Seu servidor pode não estar configurado para enviar e-mails por este método.';
$lang['email_send_failure_smtp'] = 'Não foi possível enviar e-mail usando PHP SMTP. Seu servidor pode não estar configurado para enviar e-mails por este método.';
...
$lang['email_no_hostname'] = 'Você não especificou um host SMTP.';
